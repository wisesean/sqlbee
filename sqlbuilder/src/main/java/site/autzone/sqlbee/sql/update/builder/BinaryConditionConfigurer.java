...
public class BinaryConditionConfigurer extends AbstractConfigableConfigurer<SqlUpateBuilder> {
	...
	public BinaryConditionConfigurer connector(String connector) throws Exception {
		binaryCondition.setConnector(connector);
		return this;
	}
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public BinaryConditionFieldConfigurer left() throws Exception {
	...
	public BinaryConditionConfigurer left(IValue value) throws Exception {
		this.binaryCondition.setLeftField(value);
		return this;
	}
	
	public BinaryConditionConfigurer left(String field) throws Exception {
		this.binaryCondition.setLeftField(new Field(field));
		return this;
	}
	
	public BinaryConditionConfigurer left(IField field) throws Exception {
		this.binaryCondition.setLeftField(field);
		return this;
	}
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public BinaryConditionFieldConfigurer right() throws Exception {
		Configurer fieldConfigurer = new BinaryConditionFieldConfigurer();
		fieldConfigurer.init(this);
		this.add(fieldConfigurer);
	...
	public BinaryConditionConfigurer right(IField field) throws Exception {
		this.binaryCondition.setRightField(field);
		return this;
	}
	
	public BinaryConditionConfigurer right(IValue value) throws Exception {
		this.binaryCondition.setRightField(value);
		return this;
	}
	
	public BinaryConditionConfigurer right(String field) throws Exception {
		this.binaryCondition.setRightField(new Field(field));
		return this;
	}
	
	@Override
	public void doConfigure(SqlUpateBuilder parent) {
	...
	private void manageAllValue(SqlUpateBuilder parent, List<ITextable> children) {
