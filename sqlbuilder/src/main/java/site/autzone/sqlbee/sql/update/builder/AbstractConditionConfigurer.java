...
public abstract class AbstractConditionConfigurer extends AbstractConfigableConfigurer<SqlUpateBuilder> {
	...
	public abstract void doConditionConfigure(SqlUpateBuilder parent);
}
